        ...
        <div class="entreprise-right">
            ...
            <div class="right-section cards-section">
                ...
                <div class="cards-grid">
                    <div class="card-item">
                        <img src="./public/image/carousel1/photo1.jpg" alt="Carte 1">
                        <p>Texte</p>
                        <button class="card-btn">Voir plus</button>
                    </div>
                    <div class="card-item">
                        <img src="./public/image/carousel1/photo2.jpg" alt="Carte 2">
                        <p>Texte</p>
                        <button class="card-btn">Voir plus</button>
                    </div>
                    <div class="card-item">
                        <img src="./public/image/carousel1/photo3.jpg" alt="Carte 3">
                        <p>Texte</p>
                        <button class="card-btn">Voir plus</button>
                    </div>
                </div>
