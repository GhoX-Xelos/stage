<!--<section class="grid3">
    ...
    <div class="content-row">
        <div class="block" id="presentation1">
            <div class="presentation-header">
                <!-- <img src="./public/image/carousel1/photo3.jpg" alt="Niak Niak Kadric">
                <h2>Titre</h2>
            </div>
        ...
        <div class="block" id="barre"> </div>
        <div class="block" id="presentation2"> </div>
    </div>
</section>